         ...
         <div class="row">
            ...
            <div class="col-sm-8 sscroll" style="background-color:lavender;">
               ...
               <div class="row" id="video">
                  <audio controls="" preload="auto" style="height:550px;width:95%;" autoplay="" crossorigin="anomymous" id="myVideo" class="playr_video">

                     <source src="http://trendsepc.in/sih2018/public/audio/<?=trim($video_name);?>" type="audio/mp3">
                  ...
                  <div  id="transcript1" style="margin-top: 2%;margin-bottom:2%;height: 140px;overflow-y: scroll;color:green;  font-size: 15px; margin-left: 2%;margin-right: 2%;" hidden>
                    ...
                    <script type="text/javascript">
                                ...
                                for(var loop=0;loop<$(".transcriptq").length;loop++){
                                        ...
                                        let urlg = "https://translation.googleapis.com/language/translate/v2?key=<key>";
                                        urlg += "&source=EN";
